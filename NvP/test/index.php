  ...
  <body>
    <nav class="navbar">
        ...
        <div class="navbar-lien">
            <ul>
                <li><a href="login.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
...
<style>
    #destinations{
        ...
        padding:0 50px;
        background-color: rgba(130, 180, 255, 0.2);
    }
    #recherche{
        padding:10px;
        border-radius:5px;
    ...
    .navbar{
        background-color: rgb(70, 150, 255,0.8);
    }
    .container {
        background-color: rgb(70, 150, 255,0.8);
